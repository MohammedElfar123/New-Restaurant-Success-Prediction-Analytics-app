...
export default function DoctorBookingDetailsPage() {
    ...
    return (
      <DashboardLayout requiredUserType="admin">
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/${locale}/admin/bookings/doctors`)}
            className="gap-2"
          >
    ...
    <DashboardLayout requiredUserType="admin">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <Badge className="mt-1 bg-emerald-50 text-emerald-700 hover:bg-emerald-50 border-emerald-200">
        ...
        <div className="space-y-6">
          {/* Doctor Info - For Doctor type, provider IS the doctor */}
          <Card className="border-slate-200 overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 bg-gradient-to-br from-emerald-100 to-emerald-50 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
                ...
                <div>
                  ...
                  <Badge className="mt-2 bg-emerald-50 text-emerald-700 hover:bg-emerald-50 border-emerald-200">
                    {booking.category?.name || booking.category_name}
                  </Badge>
                </div>
              </div>
