...
export default function DoctorBookingsPage() {
  ...
  // Fetch ALL bookings and filter by Doctor type on frontend
  const fetchBookings = useCallback(async () => {
    ...
    if (result.success) {
      // Filter on frontend to ensure only Doctor type bookings are shown
  ...
  const handleViewBooking = (booking) => {
    setOpenDropdown(null);
    router.push(`/${locale}/admin/bookings/doctors/${booking.id}`);
  };
  ...
  return (
    <DashboardLayout requiredUserType="admin">
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        {/* Table - Doctor bookings show doctor info in provider column */}
              ...
              <tbody>
                {bookings.map((booking, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      {/* For Doctor type, provider IS the doctor */}
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                        ...
                        {booking.category_name && (
                          <Badge className="bg-emerald-50 text-emerald-700 hover:bg-emerald-50 border-emerald-200 font-medium text-xs">
                            {booking.category_name}
                          </Badge>
                        )}
                      </div>
